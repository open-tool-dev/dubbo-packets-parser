...
class TestcaseListParserTest(AbstractParserTest):
    ...
    def test(self):
        props = ["field0", "field1", "field2", "field3", "field4", "field5", "field6", "field7", "field8"]
            ...
            try:
                ...
                process = subprocess.run(
                    [
                        ...
                        "org.apache.dubbo.parser.parser.TestcaseV9ListParser",
                ...
                for k in range(0, len(testcase)):
                    ...
                    for prop in props:
                        ...
                        elif type(p[prop]) is datetime.datetime or n[prop] is datetime.datetime:
                            self.compare_date(p[prop], n[prop])
                        else:
