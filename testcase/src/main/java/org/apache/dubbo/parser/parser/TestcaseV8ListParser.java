...
public class TestcaseV8ListParser extends AbstractParser {
    ...
    public TestcaseV8ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV8> list = Lists.newArrayListWithCapacity(this.count);
