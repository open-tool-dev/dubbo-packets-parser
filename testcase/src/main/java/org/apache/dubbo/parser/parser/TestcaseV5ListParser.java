...
import org.apache.dubbo.parser.testcase.TestcaseV5;
...
public class TestcaseV5ListParser extends AbstractParser {
    ...
    public TestcaseV5ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV5> list = Lists.newArrayListWithCapacity(this.count);
        for (int t = 0; t < this.count; ++t) {
            ...
            TestcaseV5 testcase = new TestcaseV5();
