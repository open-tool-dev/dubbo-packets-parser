...
import org.apache.dubbo.parser.testcase.TestcaseV9;
...
public class TestcaseV9ListParser extends AbstractParser {
    ...
    public TestcaseV9ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV9> list = Lists.newArrayListWithCapacity(this.count);
        for (int t = 0; t < this.count; ++t) {
            ...
            TestcaseV9 testcase = new TestcaseV9();
            ...
            testcase.setField8(new Date(System.currentTimeMillis()));
            list.add(testcase);
        }
