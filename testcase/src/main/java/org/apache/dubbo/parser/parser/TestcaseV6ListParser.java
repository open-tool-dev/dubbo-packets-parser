...
public class TestcaseV6ListParser extends AbstractParser {
    ...
    public TestcaseV6ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV6> list = Lists.newArrayListWithCapacity(this.count);
        for (int t = 0; t < this.count; ++t) {
            ...
            TestcaseV6 testcase = new TestcaseV6();
