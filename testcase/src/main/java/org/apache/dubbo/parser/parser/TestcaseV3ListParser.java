...
import org.apache.dubbo.parser.testcase.TestcaseV3;
...
public class TestcaseV3ListParser extends AbstractParser {
    ...
    public TestcaseV3ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV3> list = Lists.newArrayListWithCapacity(this.count);
        for (int t = 0; t < this.count; ++t) {
            ...
            TestcaseV3 testcase = new TestcaseV3();
