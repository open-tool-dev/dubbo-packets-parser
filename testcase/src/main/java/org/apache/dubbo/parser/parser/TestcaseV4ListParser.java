...
import org.apache.dubbo.parser.testcase.TestcaseV4;
...
public class TestcaseV4ListParser extends AbstractParser {
    ...
    public TestcaseV4ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV4> list = Lists.newArrayListWithCapacity(this.count);
        for (int t = 0; t < this.count; ++t) {
            ...
            TestcaseV4 testcase = new TestcaseV4();
