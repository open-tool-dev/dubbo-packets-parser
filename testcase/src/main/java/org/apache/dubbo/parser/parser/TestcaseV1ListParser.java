...
import org.apache.dubbo.parser.testcase.TestcaseV1;
...
public class TestcaseV1ListParser extends AbstractParser {
    ...
    public TestcaseV1ListParser(String[] args) {
        super(args);
    ...
    public void test() throws Exception {
        final List<TestcaseV1> list = Lists.newArrayListWithCapacity(this.count);
        for (int t = 0; t < this.count; ++t) {
            ...
            TestcaseV1 testcase = new TestcaseV1();
